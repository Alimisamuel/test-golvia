...
import { editAtheleteProfile, upgradeAtheleteProfile } from "api/profile";
...
const MediaUpload = (props: Props) => {
  ...
  const [uploadVideoProgress, setVideoUploadProgress] = React.useState<number>(
    0
  );
    ...
    <>
      ...
      >
        <Stack width={{ xs: "100%", lg: "50%" }}>
          <h2 className="text-[#AAB1C0] text-xl font-medium">
          ...
          <div className="mt-8 border border-[#B4C1D4] border-dashed rounded-2xl bg-quaternary py-8 text-senary">
            {imageFiles.length >= 1 ? (
              <div className="px-10 mb-6">
                ...
                <p className="text-senary text-sm mb-5">
                  {imageFiles[0]?.name}
                </p>
                <LinearProgress
                  variant="buffer"
                ...
                />
                <p className="text-nonenary text-xs mt-2">
                  {uploadImageStatus}
                </p>
              </div>
            ) : (
            ...
            <p className="text-xs px-10 mt-2 mb-8">
              File type: <span className="text-[#909090]">PNG, JPEG</span> -
              File size: <span className="text-[#909090]">2MB max</span>
            </p>
            ...
            <p className="text-xs px-10 mt-2">
              File type: <span className="text-[#909090]">MOV, MP4</span> - File
              size: <span className="text-[#909090]">30MB max</span>
            </p>
          </div>
          ...
          <div>
            <div className="w-full mt-8 lg:mt-14 bg-quaternary rounded-2xl pb-4">
                ...
                <Stack direction={{ xs: "column", sm: "row" }} spacing={2}>
                  ...
                  <Stack>
                    ...
                    <p className="text-[#7D7D7D] text-xs">
                      Current Club:{" "}
                      <span className="text-black">{currentclub}</span>
                    </p>
                    <div>
              ...
              <Stack marginTop={2} paddingX={4}>
                <h3 className="text-senary text-base font-medium">
                  My Video Reel
                </h3>
