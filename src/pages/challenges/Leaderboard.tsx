...
import { useGetChallengeByIdQuery, useLazyGetLeaderboardQuery } from "services/challenge/api";
  ...
  return (
    <AccessLayout path={PATHS.CHALLENGE.LEADERBOARD}>
      <FeedLayout ref={scrollRef}>
        <>
          <Box p={{ xs: 1, sm: 2, md: 3 }} className="bg-white rounded-3xl text-gv-black_1A1C1F">
            <Stack direction="row" alignItems="center" spacing={0.5} justifySelf="center">
              <Typography variant="h$24" fontSize="26px" fontWeight={500} textAlign="center">
            ...
            <Stack direction="row" justifyContent="space-between" alignItems="center">
              <Typography variant="h$24" fontSize="22px" lineHeight="18px" py={0.5} mt={3.5} mb={1}>
                Leaderboard
              </Typography>
              <Button
                variant="outlined"
                  ...
                  <Stack
                    ...
                    onClick={() => {
                      if (item.user?.email === email) {
                        ...
                        sendUserToNextPage(item.user.email, item.user.firstName);
                      }
                    }}
                  >
                    <Stack direction="row" spacing={1.5} alignItems="center">
                      ...
                      <Stack>
                        ...
                        {!!item.user.connections && (
                          <Typography variant="p$14" fontSize="12px" color="textSecondary">
